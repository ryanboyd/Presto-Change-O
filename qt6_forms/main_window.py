...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.progressBar.setGeometry(QRect(20, 680, 631, 31))
        ...
        self.StatusLabel.setGeometry(QRect(20, 640, 631, 31))
        ...
        self.RunButton.setGeometry(QRect(70, 540, 231, 61))
        font = QFont()
        ...
        self.ExtraFileOptionsGroupbox.setGeometry(QRect(20, 370, 631, 141))
        ...
        self.CopyMetadataCheckbox.setGeometry(QRect(10, 40, 601, 31))
        ...
        self.IncludeNonAudioCheckbox.setGeometry(QRect(10, 80, 601, 31))
        self.IncludeNonAudioCheckbox.setChecked(True)
        self.AboutButton = QPushButton(self.centralwidget)
        self.AboutButton.setObjectName(u"AboutButton")
        self.AboutButton.setGeometry(QRect(380, 540, 231, 61))
        ...
        self.ConversionOptionsGroupBox.setGeometry(QRect(20, 210, 631, 141))
        ...
        self.InputFileFormatComboBox.setGeometry(QRect(20, 70, 151, 31))
        ...
        self.InputFileFormatLabel.setGeometry(QRect(20, 40, 151, 31))
        self.InputFileFormatLabel.setFont(font1)
        self.InputFileFormatLabel.setAlignment(Qt.AlignCenter)
        ...
        self.OutputFileFormatLabel.setGeometry(QRect(240, 40, 151, 31))
        self.OutputFileFormatLabel.setFont(font1)
        self.OutputFileFormatLabel.setAlignment(Qt.AlignCenter)
        ...
        self.OutputFileFormatComboBox.setGeometry(QRect(240, 70, 151, 31))
        ...
        self.OutputFileParametersLabel.setGeometry(QRect(460, 40, 151, 31))
        self.OutputFileParametersLabel.setFont(font1)
        self.OutputFileParametersLabel.setAlignment(Qt.AlignCenter)
        ...
        self.OutputFileParametersComboBox.setGeometry(QRect(460, 70, 151, 31))
...
"Input Folder", None))
        ...
        self.CopyMetadataCheckbox.setText(QCoreApplication.translate("MainWindow", u"Copy non-audio files (e.g., images, log files, etc.) to output folder(s)", None))
        self.IncludeNonAudioCheckbox.setText(QCoreApplication.translate("MainWindow", u"Attempt to copy file metadata (e.g., tags) to converted files", None))
        ...
        self.InputFileFormatLabel.setText(QCoreApplication.translate("MainWindow", u"Input File Format:", None))
        self.OutputFileFormatLabel.setText(QCoreApplication.translate("MainWindow", u"Output File Format:", None))
        self.OutputFileParametersLabel.setText(QCoreApplication.translate("MainWindow", u"Output File Option:", None))
    # retranslateUi
