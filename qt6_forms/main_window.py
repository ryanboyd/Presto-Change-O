...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.IncludeNonAudioCheckbox.setGeometry(QRect(10, 40, 601, 31))
        ...
        self.CopyMetadataCheckbox.setGeometry(QRect(10, 80, 601, 31))
        ...
        self.InputFileFormatComboBox.setGeometry(QRect(20, 70, 121, 31))
        ...
        self.InputFileFormatLabel.setGeometry(QRect(20, 40, 121, 31))
        ...
        self.OutputFileFormatLabel.setGeometry(QRect(160, 40, 121, 31))
        ...
        self.OutputFileFormatComboBox.setGeometry(QRect(160, 70, 121, 31))
        ...
        self.OutputFileParametersLabel.setGeometry(QRect(300, 40, 311, 31))
        ...
        self.OutputFileParametersComboBox.setGeometry(QRect(300, 70, 311, 31))
...
"Input Folder", None))
        ...
        self.IncludeNonAudioCheckbox.setText(QCoreApplication.translate("MainWindow", u"Copy non-audio files (e.g., images, log files, etc.) to output folder(s)", None))
        self.CopyMetadataCheckbox.setText(QCoreApplication.translate("MainWindow", u"Attempt to copy file metadata (e.g., tags) to converted files", None))
        ...
        self.InputFileFormatLabel.setText(QCoreApplication.translate("MainWindow", u"Input File Type", None))
        self.OutputFileFormatLabel.setText(QCoreApplication.translate("MainWindow", u"Output File Type", None))
